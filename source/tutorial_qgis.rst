...
Ve a la `página de SIG Web <https://my.nextgis.com/webgis/>`_ de tu cuenta de NextGIS ID y copia el enlace a tu SIG Web (consulta: `Crea una cuenta gratuita y un SIG Web <tutorial_qgis.rst#paso-15-crea-una-cuenta-gratuita-y-un-sig-web>`_). En este ejemplo, el enlace es: ``https://ngw-inicio.nextgis.com``.
